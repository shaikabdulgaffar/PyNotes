...
topicOrder.push('intro-programming-languages', 'what-is-python', 'features-advantages', 'history-versions', 'applications', 'installation-ide', 'first-program', 'comments', 'indentation', 'keywords', 'escape-sequence', 'variables', 'datatypes', 'basic-datatypes', 'advanced-datatypes');
...
Object.assign(unitTopicsByName, {
  'Unit I': ['intro-programming-languages', 'what-is-python', 'features-advantages', 'history-versions', 'applications', 'installation-ide', 'first-program', 'comments', 'indentation', 'keywords', 'escape-sequence', 'variables', 'datatypes', 'basic-datatypes', 'advanced-datatypes']
});

// Enable/disable this entire unit (Unit 1)
function enableUnit1() {
  ['intro-programming-languages', 'what-is-python', 'features-advantages', 'history-versions', 'applications', 'installation-ide', 'first-program', 'comments', 'indentation', 'keywords', 'escape-sequence', 'variables', 'datatypes', 'basic-datatypes', 'advanced-datatypes'].forEach(id => { topicAvailability[id] = true; });
  console.log('Enabled entire Unit 1');
}
function disableUnit1() {
  ['intro-programming-languages', 'what-is-python', 'features-advantages', 'history-versions', 'applications', 'installation-ide', 'first-program', 'comments', 'indentation', 'keywords', 'escape-sequence', 'variables', 'datatypes', 'basic-datatypes', 'advanced-datatypes'].forEach(id => { topicAvailability[id] = false; });
  console.log('Disabled entire Unit 1');
}
